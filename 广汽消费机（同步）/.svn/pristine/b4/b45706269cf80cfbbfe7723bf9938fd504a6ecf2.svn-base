...
/*----------------------------------------------------------------------------*/	
 ...
 else 
	{
		...
		{
		  	case 0x01:  {	/*WP_readcard_ret = WP_CheckCard();*/  		if(Enable_Pay_Card)
		{ WP_Card_Read_falg =1;  	}		}	break;					//读取卡内余额
			
			  case 0x02:   WP_Consumption_falg=1 ;   WP_retcycle =1; 	      break;				  //消费
...
//			}	
  ...
  else if (WP_Consumption_falg)      //收到智盘消费的指令
	{
			 Wisdom_plate_Consumption();		
