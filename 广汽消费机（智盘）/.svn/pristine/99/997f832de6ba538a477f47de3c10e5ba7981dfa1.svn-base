...
//擦除一个山区的最少时间:150ms
void SPI_Flash_Erase_Sector_1(uint32_t Dst_Addr)   
{   
	//  Dst_Addr*=4096;
    SPI_FLASH_Write_Enable();                  //SET WEL 	 
    SPI_Flash_Wait_Busy();   
...
//    SPI1_ReadWriteByte((u8)Dst_Addr);  
	  ...
	  SPI1_ReadWriteByte(((Dst_Addr & 0xFFFFFF) >> 16));/* send 3 address bytes */
	  SPI1_ReadWriteByte(((Dst_Addr & 0xFFFF) >> 8));
	  SPI1_ReadWriteByte(Dst_Addr & 0xFF);
