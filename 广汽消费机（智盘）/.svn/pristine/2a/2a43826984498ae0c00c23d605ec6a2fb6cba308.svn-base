...
uint releasex=0,releasey=0;
 ...
 extern volatile uchar touchmode,touchflag;
  extern volatile uint drx,dry;

unsigned char CTP_CFG_GROUP1[] =  {

};
...
{  
 ...
 {	 
	 case 0x01:	 
       {
				 if(touchflag==0)
				 { touchflag=1;TIM_Cmd(TIM2,ENABLE);beep(1);		
					senttouch(1,x,y); 
				 } 
			 } break;
		 case 0x02:	 
 ...
 int32_t GTP_Init_Panel(void)
{
 ...
 uint8_t* cfg_info;
   ...
   // GTP_DEBUG_FUNC();	
		cfg_info =  CTP_CFG_GROUP1;//指向寄存器配置
			cfg_info_len = CFG_GROUP_LEN(CTP_CFG_GROUP1) ;//计算配置表的大小
...
static void GT91xx_Config_Read_Proc(void)
{
    ...
    GTP_I2C_Read(GTP_ADDRESS, temp_data, GTP_CONFIG_MAX_LENGTH + 2);
    for (i = 0 ; i < GTP_CONFIG_MAX_LENGTH ; i++)
    {
