...
//	
	...
	PutString(100,10,"机号:");		//在指定位置开始显示ASCII字符串
	
	PutString(180,10,machno_ASCII);
...
//  Balance_Plus_minus = Server_Returndata[28];        //拷贝姓名		
		...
		if(type==PAY_OK)                //刷卡成功
		{
		  ...
		  SYN6288_Send(SYN6288CMD_VOICE_PLAY ,SYN6288CMDPARAM_PLAY_MUSIC0,"支付成功" ,8);
...
//												DrawRect(165+ t*16,50 +j,16 ,32,LCD_GREEN,0);    //选择框				
		  ...
		  case   0x70:  {						                                        //设备信息
											PutString(5,10,  "设备名称    KETAN2166") ;								

											PutString(5,60,  "机器型号    20180710") ;
											
											PutString(5,110, "机器编号    20180710") ;

                      PutString(5,160, "出厂日期    20190212") ;

											PutString(5,210, "版本号     科坦一卡通") ; 
