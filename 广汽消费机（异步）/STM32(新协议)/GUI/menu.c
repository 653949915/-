...
//	uint8_t  def_maxConsumebuf[3] = {0x05 ,0x00 ,0x00};
...
//											
//										if( MyStrCMP(menuConsumebuf, def_maxConsumebuf, 2)<=2)         //消费金额对比
//										{
//										
//										   memcpy(Sub_Maximum_Limitbuf +1 , menuConsumebuf ,3);       //  拷贝 金额
//										
//										}
//											else 
//											{
//											  memcpy(Sub_Maximum_Limitbuf +1 , def_maxConsumebuf ,3);       //  拷贝 金额
//											}
