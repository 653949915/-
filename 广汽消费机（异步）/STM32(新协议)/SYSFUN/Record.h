...
#define MAX_RECORD		205700L //((W25X_PAGE_SIZE *W25X_PAGE_NUM)/RECORD_SIZE)  /*(1920*3215)/30 = 205760*/   205760（实际能够存储数量）     //((MAX_PAGE * SECTOR_SIZE - RECORD_ST) / RECORD_SIZE)  //(2048*4096-0)/30=279620 
...
extern	uint8_t  recorddata[];            //flash存储的数据（30字节）

extern	uint8_t  recorddataup[];            //flash存储的数据（30字节）
