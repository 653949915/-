...
/***************----- 端口0数据缓冲区 -----***************/
extern unsigned char S0_Rx_Buffer[];	//端口接收数据缓冲区 
extern unsigned char S0_Tx_Buffer[];	//端口发送数据缓冲区  

/***************----- 端口1数据缓冲区 -----***************/
extern unsigned char S1_Rx_Buffer[];	//端口接收数据缓冲区 
extern unsigned char S1_Tx_Buffer[];	//端口发送数据缓冲区  

/***************----- 端口1数据缓冲区 -----***************/
extern unsigned char S2_Rx_Buffer[];	//端口接收数据缓冲区 
extern unsigned char S2_Tx_Buffer[];	//端口发送数据缓冲区  
